# Smooth Whiteboard — übernommener Foundation-Plan

> Historische Referenz des importierten Canvas-Projekts. Der verbindliche Plan für AI Teacher Notes steht in [`BUILD_PLAN.md`](BUILD_PLAN.md); Herkunft und Hackathon-Delta sind separat dokumentiert.
