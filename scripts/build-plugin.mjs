...
const zip = spawnSync("zip", ["-q", "-r", "smooth-handwriting-0.16.0-preview.zip", "smooth-handwriting"], { cwd: "plugin-dist", stdio: "inherit" });
if (zip.status !== 0) throw new Error("ZIP packaging failed (install zip)");
console.log("Packaged plugin-dist/smooth-handwriting-0.16.0-preview.zip");
